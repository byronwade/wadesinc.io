		...
		<div className="mb-12">
			<div className="mx-auto max-w-7xl px-6 pt-10 pb-24 sm:pb-32 lg:flex lg:py-40 lg:px-8">
				<div className="isolate">
					...
					<p>Tax Incentives: In some cases, you may be eligible for tax credits or deductions for installing energy-efficient plumbing equipment. Check with a tax professional or visit the IRS website (https://www.irs.gov) for information on available tax credits.</p>

					<p>Trade Associations: Join trade associations or industry groups related to plumbing, heating, and cooling. These organizations may offer access to rebate programs, training, and resources specific to your industry.</p>
				</div>
			</div>
		</div>
	);
