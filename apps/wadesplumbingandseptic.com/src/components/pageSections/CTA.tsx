			...
			<div className="mx-auto max-w-7xl py-24 sm:py-32 px-6 lg:px-8">
				<div className="flex flex-col sm:flex-row justify-between items-center">
					<div className="pr-4 basis-full sm:basis-9/12 md:basis-9/12 lg:basis-10/12">
						...
						<p className="text-lg leading-6 text-gray-600">Flowbite helps you connect with friends, family and communities of people who share your interests. Connecting with your friends and family as well as discovering new ones is easy with features like Groups, Watch and Marketplace.</p>
					</div>
