		...
		<section className="dark:bg-black bg-white border-t">
			<div className="mx-auto max-w-7xl py-24 sm:py-32">
				<div className="flex flex-col sm:flex-row justify-between items-center">
					<div className="basis-full sm:basis-9/12 md:basis-9/12 lg:basis-10/12">
					...
					<div className="flex flex-col space-y-4 basis-full sm:basis-3/12 md:basis-3/12 lg:basis-2/12">
						<a href="#" className="w-full inline-flex items-center justify-center px-4 py-2.5 text-base font-medium text-center text-white bg-brand rounded-lg hover:bg-brand-600 focus:ring-4 focus:ring-brand-300 dark:focus:ring-brand-900">
							Get a Quote
						</a>
						<a href="#" className="w-full inline-flex items-center justify-center px-4 py-2.5 text-base font-medium text-center text-black border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
